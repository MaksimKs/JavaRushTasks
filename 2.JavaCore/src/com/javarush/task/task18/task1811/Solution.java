...
public class Solution {
    ...
    public static class DecoratorMyRunnableImpl implements Runnable {
        private Runnable componentOriginal;

        public DecoratorMyRunnableImpl(Runnable componentOriginal) {
            this.componentOriginal = componentOriginal;
        }

        @Override
        public void run() {
            System.out.print("DecoratorMyRunnableImpl body ");
            componentOriginal.run();
        }
    }
